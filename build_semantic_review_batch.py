...
ASSIGNMENTS = {
    ...
    "ai25_interspeech": ("people-variation-and-health", "speaker-characteristics", "speaker-identity", "The longitudinal recordings ask how speaker verification changes as a person ages; time-varying identity is the phenomenon being measured."),
    ...
    "abdullah25_interspeech": ("people-variation-and-health", "speaker-characteristics", "speaker-identity", "Voice conversion is used as augmentation to reduce speaker bias, and the real-world cross-domain test asks whether identity variation is being mistaken for task evidence."),
    ...
    "alabi25_interspeech": ("languages-accents-and-resources", "low-resource-and-data-creation", "self-training-and-pseudo-labels", "The paper expands self-supervised pretraining across African languages so useful speech units can be learned where labeled data are scarce."),
