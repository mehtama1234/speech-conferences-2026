...
| corpus-wide-semantic-dispositions | `verified-with-boundaries` | Every INTERSPEECH and ICASSP record has an explicit disposition with preserved evidence and unresolved reason: INTERSPEECH {'analyst-confirmed': 1129, 'analyst-rejected': 50}, ICASSP {'analyst-rejected': 3254, 'analyst-confirmed': 609, 'analyst-unresolved': 1}. Provisional candidates are visibly not counted as analyst-confirmed. |
...
| current-taxonomy-membership-adjudication | `in-progress` | The current taxonomy has 1675 supported memberships still awaiting re-adjudication and 64 adjudicated in the current queue. Prior semantic review and mechanical normalization are preserved, but they are not treated as final current-boundary decisions. |
