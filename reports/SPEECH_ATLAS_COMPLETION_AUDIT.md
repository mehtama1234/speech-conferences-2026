...
| current-taxonomy-membership-adjudication | `in-progress` | The current taxonomy has 1739 supported memberships awaiting re-adjudication after concept parents changed. Prior semantic review and mechanical normalization are preserved, but they are not treated as final current-boundary decisions. |
