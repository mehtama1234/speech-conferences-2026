...
| current-taxonomy-membership-adjudication | `in-progress` | The current taxonomy has 1049 supported memberships still awaiting re-adjudication and 690 adjudicated in the current queue. Prior semantic review and mechanical normalization are preserved, but they are not treated as final current-boundary decisions. |
