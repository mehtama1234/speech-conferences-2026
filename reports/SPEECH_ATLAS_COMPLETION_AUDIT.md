...
| corpus-wide-semantic-dispositions | `verified-with-boundaries` | Every INTERSPEECH and ICASSP record has an explicit disposition with preserved evidence and unresolved reason: INTERSPEECH {'analyst-confirmed': 1126, 'analyst-rejected': 53}, ICASSP {'analyst-rejected': 3399, 'analyst-confirmed': 464, 'analyst-unresolved': 1}. Provisional candidates are visibly not counted as analyst-confirmed. |
