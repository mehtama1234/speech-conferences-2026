...
| current-taxonomy-membership-adjudication | `in-progress` | The current taxonomy has 785 supported memberships still awaiting re-adjudication and 954 adjudicated in the current queue. Prior semantic review and mechanical normalization are preserved, but they are not treated as final current-boundary decisions. |
