...
| first-principles-writeups | `in-progress` | The writeup gate finds 28 of 34 subthemes complete against the required plain-language fields. This checks presence and evidence links; human review is still required for conceptual correctness. |
