...
## 1. Optimizing CLAP Reward with LLM Feedback for Semantically Aligned and Diverse Automated Audio Captioning
...
**Taxonomy:** `evaluation-deployment-and-consequence / metrics-and-targets / quality-and-naturalness`
...
## 2. SMARTMOS: Modeling Subjective Audio Quality Evaluation for Real-Time Applications
...
## 3. Intelligibility Prediction for Time-Modified Speech Signals Using Spectro-Temporal Modulation Features
...
**Taxonomy:** `evaluation-deployment-and-consequence / metrics-and-targets / word-error-versus-understanding`
...
## 4. Benchmarking and Confidence Evaluation of LALMs For Temporal Reasoning
...
**Taxonomy:** `evaluation-deployment-and-consequence / metrics-and-targets / calibration-and-selective-use`
...
## 5. Benchmarking Time-localized Explanations for Audio Classification Models
...
## 8. Towards LLM-Empowered Fine-Grained Speech Descriptors for Explainable Emotion Recognition
...
## 9. Temp4Cap: Temporally-aligned Automated Audio Captioning
...
## 10. Enhancing Retrieval-Augmented Audio Captioning with Generation-Assisted Multimodal Querying and Progressive Learning
...
## 11. Multivariate Probabilistic Assessment of Speech Quality
...
## 12. Non-intrusive Speech Quality Assessment with Diffusion Models Trained on Clean Speech
...
## 13. Beyond Similarity Scoring: Detecting Entailment and Contradiction in Multilingual and Multimodal Contexts
...
## 14. AttentiveMOS: A Lightweight Attention-Only Model forSpeech Quality Prediction
...
## 15. Enabling the replicability of speech synthesis perceptual evaluations
...
## 16. Voice Quality Dimensions as Interpretable Primitives for Speaking Style for Atypical Speech and Affect
...
## 17. Multimodal and Multitask Learning for Predicting Multiple Scores in L2 English Speech
...
## 18. Aligning ASR Evaluation with Human and LLM Judgments: Intelligibility Metrics Using Phonetic, Semantic, and NLI Approaches
...
## 19. On the reliability of feature attribution methods for speech classification
...
## 20. Collecting, Curating, and Annotating Good Quality Speech deepfake dataset for Famous Figures: Process and Challenges
...
**Taxonomy:** `evaluation-deployment-and-consequence / privacy-security-and-accountability / spoofing-and-deepfake`
...
## 21. ATMM-SAGA: Alternating Training for Multi-Module with Score-Aware Gated Attention SASV system
...
## 22. WavShape: Information-Theoretic Speech Representation Learning for Fair and Privacy-Aware Audio Processing
...
**Taxonomy:** `evaluation-deployment-and-consequence / privacy-security-and-accountability / voice-privacy`
...
## 23. PhonemeFake: Redefining Deepfake Realism with Language-Driven Segmental Manipulation and Adaptive Bilevel Detection
...
## 24. Hear Me Out: Interactive evaluation and bias discovery platform for speech-to-speech conversational AI
...
**Taxonomy:** `evaluation-deployment-and-consequence / privacy-security-and-accountability / auditability-and-contestability`
...
## 25. Evaluating Parameter Sharing for Spoofing-Aware Speaker Verification: A Case Study on the ASVspoof 5 Dataset
...
## 26. Beyond Attacks: Advancing Fake Speech Detection with Attack-Agnostic Methods
...
## 27. Codec-Based Deepfake Source Tracing via Neural Audio Codec Taxonomy
...
## 28. Generalizable Audio Spoofing Detection using Non-Semantic Representations
...
## 29. Can Quantized Audio Language Models Perform Zero-Shot Spoofing Detection?
...
## 30. Audio Deepfake Source Tracing using Multi-Attribute Open-Set Identification and Verification
...
## 31. Rehearsal with Auxiliary-Informed Sampling for Audio Deepfake Detection
...
## 32. STOPA: A Dataset of Systematic VariaTion Of DeePfake Audio for Open-Set Source Tracing and Attribution
...
## 33. LitMAS: A Lightweight and Generalized Multi-Modal Anti-Spoofing Framework for Biometric Security
...
## 34. Privacy-Preserving Speaker Verification via End-to-End Secure Representation Learning
...
## 35. CBA: Backdoor Attack on Deep Speech Classification via Audio Compression
...
## 36. From Sharpness to Better Generalization for Speech Deepfake Detection
...
## 37. FaiST: A Benchmark Dataset for Fairness in Speech Technology
...
## 38. ``Alexa, can you forget me?'' Machine Unlearning Benchmark in Spoken Language Understanding
...
## 39. LRBA: Stealthy Backdoor Attacks on Speech Classification via Latent Rearrangement in VITS
...
## 40. A Comprehensive Real-World Assessment of Audio Watermarking Algorithms: Will They Survive Neural Codecs?
...
## 41. Towards Machine Unlearning for Paralinguistic Speech Processing
...
## 42. Evaluating ASR Robustness to Spontaneous Speech Errors: A Study of WhisperX Using a Speech Error Database
...
**Taxonomy:** `evaluation-deployment-and-consequence / robustness-and-system-boundary / distribution-shift`
...
## 43. Defending Speech-enabled LLMs Against Adversarial Jailbreak Threats
...
**Taxonomy:** `evaluation-deployment-and-consequence / robustness-and-system-boundary / end-to-end-recovery`
...
## 44. Pushing the Limits of End-to-End Diarization
...
## 45. NanoCodec: Towards High-Quality Ultra Fast Speech LLM Inference
...
**Taxonomy:** `evaluation-deployment-and-consequence / robustness-and-system-boundary / latency-and-resource`
...
## 46. Breaking Resource Barriers in Speech Emotion Recognition via Data Distillation
...
## 47. Multi-Channel Sequence-to-Sequence Neural Diarization: Experimental Results for The MISP 2025 Challenge
...
## 48. Unmasking real-world audio deepfakes: A data-centric approach
...
## 49. PruneSLU: Efficient On-device Spoken Language Understanding through Vocabulary and Structural Pruning
...
## 50. GTA: Towards Generative Text-To-Audio Retrieval via Multi-Scale Tokenizer
...
## 51. Ultra-Low Bit Post-Training Quantization of Large Speech Models via K-Means Clustering and Mixed Precision Allocation
...
## 52. Improving Generalization of End-to-End ASR through Diversity and Independence Regularization
...
## 53. Unfolding A Few Structures for The Many: Memory-Efficient Compression of Conformer and Speech Foundation Models
...
## 54. Simultaneous Masked and Unmasked Decoding with Speculative Decoding Masking for Fast ASR without Accuracy Loss
...
## 55. SpecTokenizer: A Lightweight Streaming Codec in the Compressed Spectrum Domain
...
## 56. Calm-Whisper: Reduce Whisper Hallucination On Non-Speech By Calming Crazy Heads Down
...
## 57. WIND: Accelerated RNN-T Decoding with Windowed Inference for Non-blank Detection
...
## 58. Effective and Efficient One-pass Compression of Speech Foundation Models Using Sparsity-aware Self-pinching Gates
...
## 59. Dynamic Acoustic Model Architecture Optimization in Training for ASR
...
**Taxonomy:** `languages-accents-and-resources / accent-and-cultural-boundaries / dialect-and-variety`
...
**Taxonomy:** `languages-accents-and-resources / accent-and-cultural-boundaries / accent-robustness`
...
**Taxonomy:** `languages-accents-and-resources / accent-and-cultural-boundaries / cultural-meaning`
...
## 79. AfriHuBERT: A self-supervised speech representation model for African languages
...
**Taxonomy:** `languages-accents-and-resources / low-resource-and-data-creation / self-training-and-pseudo-labels`
...
## 80. Evaluating Large Language Models in Data Generation for Low-Resource Scenarios: A Case Study on Question Answering
...
## 81. Better Semi-supervised Learning for Multi-domain ASR Through Incremental Retraining and Data Filtering
...
## 82. MSDA: Combining Pseudo-labeling and Self-Supervision for Unsupervised Domain Adaptation in ASR
...
## 83. Speechless: Speech Instruction Training Without Speech for Low Resource Languages
...
**Taxonomy:** `languages-accents-and-resources / low-resource-and-data-creation / few-shot-adaptation`
...
## 84. Nosey: Open-Source Hardware for Acoustic Nasalance
...
**Taxonomy:** `languages-accents-and-resources / low-resource-and-data-creation / speech-data-collection`
...
## 85. Transcribing Oral History Recordings Using the Transcription Portal
...
## 86. The NaijaVoices Dataset: Cultivating Large-Scale, High-Quality, Culturally-Rich Speech Data for African Languages
...
## 87. Multi-view Fusion and Parameter Perturbation for Few-Shot Class-Incremental Audio Classification
...
## 88. Speech LLMs in Low-Resource Scenarios: Data Volume Requirements and the Impact of Pretraining on High-Resource Languages
...
## 89. Evaluating Wav2Vec2-Bert for Computer-Assisted Pronunciation Training for isiZulu
...
## 90. Few-Shot Speech Deepfake Detection Adaptation with Gaussian Processes
...
## 91. Pushing the Limits of Beam Search Decoding  for Transducer-based ASR models
...
## 92. Automatic Speech Recognition for Low-Resourced Middle Eastern Languages
...
## 93. An Effective Training Framework for Light-Weight Automatic Speech Recognition Models
...
## 94. Hybrid Data Sampling for ASR: Integrating Acoustic Diversity and Transcription Uncertainty
...
## 95. An Exploratory Framework for LLM-assisted Human Annotation of Speech Datasets
...
## 96. Speech Annotation for A: Accuracy, Access, and Application
...
## 97. The Faetar Speech Recognition Benchmark
...
## 98. LiRI Corpus Platform: Demonstration of a Web-Based Infrastructure for Multimodal Corpus Analysis
...
## 99. SpokenNativQA: Multilingual Everyday Spoken Queries for LLMs
...
**Taxonomy:** `languages-accents-and-resources / multilingual-and-crosslingual / code-switching`
...
## 100. TalTech Systems for the Interspeech 2025 ML-SUPERB 2.0 Challenge
...
**Taxonomy:** `languages-accents-and-resources / multilingual-and-crosslingual / language-identification`
...
## 101. A Study of Speech Embedding Similarities Between Australian Aboriginal and High-Resource Languages
...
**Taxonomy:** `languages-accents-and-resources / multilingual-and-crosslingual / crosslingual-transfer`
...
## 102. From Context to Code-switching: Examining the Interplay of Language Proficiency and Multilingualism in Speech
...
## 103. Adapting Whisper for low-resource Hindi-English Code-Mix speech with on-the-fly Augmentation & LLM-Synthesised Data
...
## 104. Teacher-Free Knowledge Distillation for Improving Short-Utterance Spoken Language Identification
...
## 105. ADI-20: Arabic Dialect Identification dataset and models
...
## 106. Speech-to-Text Translation with Phoneme-Augmented CoT: Enhancing Cross-Lingual Transfer in Low-Resource Scenarios
...
## 107. Self-Supervised Models of Speech Processing for Haitian Creole
...
## 108. NIRANTAR: Continual Learning with New Languages and Domains on Real-world Speech Data
...
## 109. Extending the Fongbe to French Speech Translation Corpus:  resources, models and benchmark
...
## 110. ArticulateX: End-to-End Monolingual Speech Translation in Articulator Space
...
## 111. Novel Parasitic Dual-Scale Modeling for Efficient and Accurate Multilingual Speech Translation
...
## 112. Efficient Multilingual ASR Finetuning via LoRA Language Experts
...
## 113. LIST: Language-Independent Speech Token for Multilingual Speech Synthesis with Language Models
...
## 114. SawtArabi: A Benchmark Corpus for Arabic TTS.  Standard, Dialectal and Code-Switching
...
## 115. Can we train ASR systems on Code-switch without real code-switch data? Case study for Singapore's languages
...
## 116. Simultaneous Speech Translation Integrated Compact Multiple Sound Spot Synthesis System On A Laptop Carried Out With A Backpack
...
## 117. CS-FLEURS: A Massively Multilingual and Code-Switched Speech Dataset
...
## 118. MiSTR: Multi-Modal iEEG-to-Speech Synthesis with Transformer-Based Prosody Prediction and Neural Phase Reconstruction
...
**Taxonomy:** `listening-and-separation / echo-and-reconstruction / perceptual-enhancement`
...
## 119. Voice-ENHANCE: Speech Restoration using a Diffusion-based Voice Conversion Framework
...
## 120. A Deformable Convolution GAN Approach for Speech Dereverberation in Cochlear Implant Users
...
## 121. Modality-Agnostic Multimodal Emotion Recognition using a Contrastive Masked Autoencoder
...
## 122. Listen through the Sound: Generative Speech Restoration Leveraging Acoustic Context Representation
...
## 123. Discovering Directions of Uncertainty in Speech Inpainting
...
**Taxonomy:** `listening-and-separation / echo-and-reconstruction / packet-loss-concealment`
...
## 124. Linguistic Masking and Its Release in Simulated Electric-acoustic Hearing
...
## 125. Extended Loss: Incorporating Long Context into Training Models when using Short Audio Frames
...
## 126. Efficient Neural and Numerical Methods for High-QualityOnline Speech Spectrogram Inversion via Gradient Theorem
...
## 127. Vision-Integrated High-Quality Neural Speech Coding
...
## 128. PAST: Phonetic-Acoustic Speech Tokenizer
...
## 129. VoiceNoNG: Robust High-Quality Speech Editing Model without Hallucinations
...
## 130. Benchmarking Neural Speech Codec Intelligibility with SITool
...
## 131. SpeechRefiner: Towards Perceptual Quality Refinement for Front-End Algorithms
...
## 132. HWB-Net: A Novel High-Performance and Efficient Hybrid Waveform Bandwidth Extension Method
...
## 133. A Neural Codec Approach for Noise-Robust Bandwidth Expansion
...
## 134. Rollback Speech: Smart Feedback Prompts for Lost Utterances in Unstable Online Calls
...
## 135. TS-URGENet: A Three-stage Universal Robust and Generalizable Speech Enhancement Network
...
## 136. Analysis and Extension of a Near-End Listening Enhancement Method Based on Long-Term Fractile Noise Statistics
...
## 137. Room Impulse Response as a Prompt for Acoustic Echo Cancellation
...
**Taxonomy:** `listening-and-separation / echo-and-reconstruction / acoustic-echo-cancellation`
...
## 138. A Three-Stage Beamforming with Harmonic Guidance for Multi-Channel Speech Enhancement
...
## 139. Structured Codebook Based Hierarchical Framework for DNN for Computationally Efficient Speech Enhancement
...
## 140. Test-Time Training for Speech Enhancement
...
## 141. QUADS: Quantized Distillation Framework for Efficient Speech Language Understanding
...
## 142. Scaling and Enhancing LLM-based AVSR:  A Sparse Mixture of Projectors Approach
...
## 143. Towards Bitrate-Efficient and Noise-Robust Speech Coding with Variable Bitrate RVQ
...
## 144. DiffDSR: Dysarthric Speech Reconstruction Using Latent Diffusion Model
...
## 145. Adaptive Knowledge Distillation for Device-Directed Speech Detection
...
## 146. First Analyze Then Enhance: A Task-Aware System for Speech Separation, Denoising, and Dereverberation
...
## 147. Improved Intelligibility of Dysarthric Speech using Conditional Flow Matching
...
## 148. Objective and Subjective Evaluation of Diffusion-Based Speech  Enhancement for Dysarthric Speech
...
## 149. Multitalker Babble in English Vowel Perception Training: A Comparison between Humans and Neural Models
...
## 150. FUSE: Universal Speech Enhancement using Multi‐Stage Fusion of Sparse Compression and Token Generation Models for the URGENT 2025 Challenge
...
## 151. Diffusion Buffer: Online Diffusion-based Speech Enhancement with Sub-Second Latency
...
## 152. Multistage Universal Speech Enhancement System for URGENT Challenge
...
## 153. Model as Loss: A Self-Consistent Training Paradigm
...
## 154. FlowSE: Efficient and High-Quality Speech Enhancement via Flow Matching
...
## 155. A Novel Deep Learning Framework for Efficient Multichannel Acoustic Feedback Control
...
## 156. Location-Aware Target Speaker Extraction for Hearing Aids
...
**Taxonomy:** `listening-and-separation / source-separation-and-spatial-listening / spatial-filtering`
...
**Taxonomy:** `listening-and-separation / source-separation-and-spatial-listening / blind-source-separation`
...
**Taxonomy:** `listening-and-separation / source-separation-and-spatial-listening / target-conditioned-separation`
...
## 160. A Study of Real-world Audio-Visual Corpus Design and Production: A Perspective from MISP Challenges
...
## 161. SoundSculpt: Direction and Semantics Driven Ambisonic Target Sound Extraction
...
## 162. Spatio-Spectral Diarization of Meetings by Combining TDOA-based Segmentation and Speaker Embedding-based Clustering
...
## 163. NeuroSpex+: Dual-Task Training of Neuro-Guided Speaker Extraction with Speech Envelope and Waveform
...
## 164. MOPSA: Mixture of Prompt-Experts Based Speaker Adaptation for Elderly Speech Recognition
...
## 165. Synchronous analysis of abnormal acoustic and linguistic production in Parkinson's speech
...
## 166. IDIR: Identifying and Distilling Informative Relations for Speaker Verification
...
## 167. Deep learning based spatial aliasing reduction in beamforming for audio capture
...
## 168. CabinSep: IR-Augmented Mask-Based MVDR for Real-Time In-car Speech Separation with Distributed Heterogeneous Arrays
...
## 169. Overlap-Adaptive Hybrid Speaker Diarization and ASR-Aware Observation Addition for MISP 2025 Challenge
...
## 170. Neural Speech Extraction with Human Feedback
...
## 171. End-to-End DOA-Guided Speech Extraction in Noisy Multi-Talker Scenarios
...
## 172. FlowTSE: Target Speaker Extraction with Flow Matching
...
## 173. Online Audio-Visual Autoregressive Speaker Extraction
...
## 174. Chain-of-Thought Training for Open E2E Spoken Dialogue Systems
...
**Taxonomy:** `meaning-and-interaction / dialogue-and-turn-taking / dialogue-state`
...
## 175. Rapport-Building Dialogue Strategies for Deeper Connection: Integrating Proactive Behavior, Personalization, and Aizuchi Backchannels
...
**Taxonomy:** `meaning-and-interaction / dialogue-and-turn-taking / turn-boundary`
...
## 176. Analysis of ABC Frontend Audio Systems for the NIST-SRE24
...
## 177. ``Dyadosyncrasy'', Idiosyncrasy and Demographic Factors in Turn-Taking
...
## 178. Multimodal Fusion with Semi-Supervised Learning Minimizes Annotation Quantity for Modeling Videoconference Conversation Experience
...
## 179. Multimodal Dynamics of Hand Gestures and Pauses in Multiparty Interactions
...
## 180. Triadic Multi-party Voice Activity Projection for Turn-taking in Spoken Dialogue Systems
...
## 181. MMLoRA: Multitask Memory Parameter-Efficient Fine-Tuning for Multimodal SER
...
## 182. Backchannel prediction for natural spoken dialog systems  using general speaker and listener information
...
## 183. Comparison-Based Automatic Evaluation for Meeting Summarization
...
## 184. Leveraging LLMs for Written to Spoken Style Data Transformation to Enhance Spoken Dialog State Tracking
...
## 185. Factors affecting the in-context learning abilities of LLMs for dialogue state tracking
...
## 186. Gaze-Enhanced Multimodal Turn-Taking Prediction in Triadic Conversations
...
## 187. Enhancing Transcripts of Open-Source Automatic Speech Recognition Models Through Fine-Tuning with Laughter and Speech-Laugh
...
**Taxonomy:** `meaning-and-interaction / dialogue-and-turn-taking / repair-and-clarification`
...
## 188. Efficient and Direct Duplex Modeling for Speech-to-Speech Language Model
...
## 189. Modeling Multi-Turn Spoken Language Understanding with Dynamic Graph Convolutional Networks
...
## 190. Dialogue Response Prefetching Based on Semantic Similarity and Prediction Confidence of Language Model
...
## 191. Visual Cues Support Robust Turn-taking Prediction in Noise
...
## 192. FD-Bench: A Full-Duplex Benchmarking Pipeline Designed for Full Duplex Spoken Dialogue Systems
...
## 193. Assessing the feasibility of Large Language Models for detecting micro-behaviors in team interactions during space missions
...
## 194. Co-Speech Motion for Virtual Agents in Dialogue Using LLM-Driven Primitive Action Selection
...
## 195. Fact-Controlled Diagnosis of Hallucinations in Medical Text Summarization
...
## 196. From Words to Waves: Analyzing Concept Formation in Speech and Text-Based Foundation Models
...
## 197. AC/DC: LLM-based Audio Comprehension via Dialogue Continuation
...
## 198. Vela: Scalable Embeddings with Voice Large Language Models for Multimodal Retrieval
...
## 199. Language-Guided Contrastive Audio-Visual Masked Autoencoder with Automatically Generated Audio-Visual-Text Triplets from Videos
...
## 200. Face2VoiceSync: Lightweight Face-Voice Consistency for Text-Driven Talking Face Generation
...
## 201. Pick and Summarize: Integrating Extractive and Abstractive Speech Summarization
...
## 202. Towards Human-like Multimodal Conversational Agent by Generating Engaging Speech
...
## 203. Teaching Audio-Aware Large Language Models What Does Not Hear: Mitigating Hallucinations through Synthesized Negative Samples
...
## 204. Bridging Audio and Vision: Zero-Shot Audiovisual Segmentation by Connecting Pretrained Models
...
## 205. Speech-IFEval: Evaluating Instruction-Following and Quantifying Catastrophic Forgetting in Speech-Aware Language Models
...
## 206. Unified Audio-Visual Modeling for Recognizing Which Face Spoke When and What in Multi-Talker Overlapped Speech and Video
...
## 207. Beat gestures made by human-like avatars affect speech perception
...
## 208. The mutual exclusivity bias of bilingual visually grounded speech models
...
## 209. Towards High-Quality LLM-Based Data for French Spontaneous Speech Simplification: an Exo-Refinement Approach
...
## 210. GenECA: A General-Purpose Framework for Real-Time Adaptive Multimodal Embodied Conversational Agents
...
## 211. SNIFR : Boosting Fine-Grained Child Harmful Content Detection Through Audio-Visual Alignment with Cascaded Cross-Transformer
...
## 212. Who Gets the Mic? Investigating Gender Bias in the Speaker Assignment of a Speech-LLM
...
## 213. Enhancing Speech Instruction Understanding and Disambiguation in Robotics via Speech Prosody
...
## 214. Spoken Question Answering for Visual Queries
...
## 215. Discrete Audio Representations for Automated Audio Captioning
...
## 216. Investigating the Reasoning Abilities of Large Language Models for Understanding Spoken Language in Interpersonal Interactions
...
**Taxonomy:** `meaning-and-interaction / prosody-and-intent / intent-in-context`
...
## 217. Spoken Language Understanding on Unseen Tasks With In-Context Learning
...
## 218. Robot-assisted Recognition of Vocal Emotions in Pseudospeech for Cochlear Implanted Adolescents
...
**Taxonomy:** `meaning-and-interaction / prosody-and-intent / paralinguistic-state`
...
## 219. Coping with segmental–prosodic incongruity in spoken word recognition in Japanese
...
**Taxonomy:** `meaning-and-interaction / prosody-and-intent / prosodic-meaning`
...
## 220. Stress in Spoken and Whistled Greek
...
## 221. Heart Rate as a Proxy Measure to Assess Human Confidence in Spoken Speech
...
## 222. Multi-Teacher Language-Aware Knowledge Distillation for Multilingual Speech Emotion Recognition
...
## 223. EmoDB 2.0: A Database of Emotional Speech in a World that is not Black or White but Grey
...
## 224. EmotionRankCLAP: Bridging Natural Language Speaking Styles and Ordinal Speech Emotion via Rank-N-Contrast
...
## 225. A-SMiLE: Affective Sparse Mixture-of-Experts Adapter with Multi-Task Learning for Spoken Dialogue Models
...
## 226. Medusa: A Multimodal Deep Fusion Multi-Stage Training Framework for Speech Emotion Recognition in Naturalistic Conditions
...
## 227. The Prosodic Characteristics of Standard Chinese Rhetorical Questions in Naturalistic Settings
...
## 228. MIKU-PAL: An Automated and Standardized Multimodal Method for Speech Paralinguistic and Affect Labeling
...
## 229. EmoSphere-SER: Enhancing Speech Emotion Recognition Through Spherical Representation with Auxiliary Classification
...
## 230. Developing a Top-tier Framework in Naturalistic Conditions Challenge for Categorized Emotion Prediction: From Speech Foundation Models and Learning Objective to Data Augmentation and Engineering Choices
...
## 231. Learning More with Less: Self-Supervised Approaches forLow-Resource Speech Emotion Recognition
...
## 232. Age-related changes in multisensory integration of emotions in an audiovisual face-prosody-semantics Stroop task
...
## 233. Multimodal Prosody Modeling: A Use Case for Multilingual Sentence Mode Prediction
...
**Taxonomy:** `people-variation-and-health / clinical-and-assistive-speech / dysarthria-and-atypical-speech`
...
## 235. Subtyping Speech Errors in Childhood Speech Sound Disorders with Acoustic-to-Articulatory Speech Inversion
...
**Taxonomy:** `people-variation-and-health / clinical-and-assistive-speech / clinical-speech-marker`
...
## 236. Acoustic and Linguistic Biomarkers for Cognitive Impairment Detection from Speech
...
## 237. Pitfalls and Limits in Automatic Dementia Assessment
...
## 238. Perception of Emotional Speech by Individuals with High Borderline Personality Features
...
## 239. Predicting Adolescent Suicidal Risk from Multi-task-based Speech: An Ensemble Learning Approach
...
## 240. Comparative Evaluation of Acoustic Feature Extraction Tools for Clinical Speech Analysis
...
## 241. Test-Time Training for Speech-based Depression Detection
...
## 242. ADCeleb: A Longitudinal Speech Dataset from Public Figures for Early Detection of Alzheimer’s Disease
...
## 243. EEG-based Voice Conversion : Hearing the Voice of Your Brain
...
**Taxonomy:** `people-variation-and-health / clinical-and-assistive-speech / augmentative-communication`
...
## 244. A Silent Speech Decoding System from EEG and EMG with Heterogenous Electrode Configurations
...
## 245. Optimizing Pause Context in Fine-Tuning Pre-trained Large Language Models for Dementia Detection
...
## 246. EEG-based Speech Decoding Based on Multi-mode Joint Modeling
...
## 247. Synthetic Dysarthric Speech: A Supplement, Not a Substitute for Authentic Data in Dysarthric Speech Recognition
...
## 248. Addressing Task Conflicts in Stuttering Detection via MMoE-Based Multi-Task Learning
...
## 249. Fairness in Dysarthric Speech Synthesis: Understanding Intrinsic Bias in Dysarthric Speech Cloning using F5-TTS
...
## 250. Personalized Fine-Tuning with Controllable Synthetic Speech from LLM-Generated Transcripts for Dysarthric Speech Recognition
...
## 251. Semantic Processing During Spoken Word Production by Children with Cochlear Implants
...
**Taxonomy:** `people-variation-and-health / human-centered-evaluation / listener-effort`
...
**Taxonomy:** `people-variation-and-health / human-centered-evaluation / user-control-and-consent`
...
**Taxonomy:** `people-variation-and-health / human-centered-evaluation / accessibility-fit`
...
**Taxonomy:** `people-variation-and-health / speaker-characteristics / age-and-development`
...
**Taxonomy:** `people-variation-and-health / speaker-characteristics / style-and-state-variation`
...
**Taxonomy:** `people-variation-and-health / speaker-characteristics / speaker-verification`
...
**Taxonomy:** `recognition-and-alignment / acoustic-unit-mapping / acoustic-to-token`
...
**Taxonomy:** `recognition-and-alignment / acoustic-unit-mapping / self-supervised-speech-units`
...
## 294. Mixture of LoRA Experts for Low-Resourced Multi-Accent Automatic Speech Recognition
...
**Taxonomy:** `recognition-and-alignment / acoustic-unit-mapping / pronunciation-variation`
...
## 295. CHSER: A Dataset and Case Study on Generative Speech Error Correction for Child ASR
...
## 296. Word stress in self-supervised speech models: A cross-linguistic comparison
...
## 297. SardinianVoxes: A Speech Recognition Dataset for the Sardinian Languages
...
## 298. DC-Spin: A Speaker-invariant Speech Tokenizer for Spoken Language Models
...
## 299. Using Neurogram Similarity Index Measure (NSIM) to Model Hearing Loss and Cochlear Neural Degeneration
...
## 300. Decoding Speaker-Normalized Pitch from EEG for Mandarin Perception
...
## 301. DiceHuBERT: Distilling HuBERT with a Self-Supervised Learning Objective
...
## 302. On-device Streaming Discrete Speech Units
...
## 303. Exploring auditory feedback mechanisms in speech recognition
...
## 304. What do self-supervised speech models know about Dutch?  Analyzing advantages of language-specific pre-training
...
## 305. Towards a Unified Benchmark for Arabic Pronunciation Assessment: Qur’anic Recitation as Case Study
...
## 306. Improving Child Speech Recognition and Reading Mistake Detection by Using Prompts
...
## 307. Improving End-to-end Mixed-case ASR with Knowledge Distillation and Integration of Voice Activity Cues
...
## 308. EnCodecMAE: leveraging neural codecs for universal audio representation learning
...
## 309. Domain Adaptation Method and Modality Gap Impact in Audio-Text Models for Prototypical Sound Classification
...
**Taxonomy:** `recognition-and-alignment / adaptation-and-open-vocabulary / domain-and-context-biasing`
...
## 310. Spot and Merge: A Hybrid Context Biasing Approach for Rare Word and Out of Vocabulary Recognition
...
## 311. Continuous Learning for Children's ASR: Overcoming Catastrophic Forgetting with Elastic Weight Consolidation and Synaptic Intelligence
...
**Taxonomy:** `recognition-and-alignment / adaptation-and-open-vocabulary / speaker-adaptation`
...
## 312. NGPU-LM: GPU-Accelerated N-Gram Language Model for Context-Biasing in Greedy ASR Decoding
...
## 313. Effect of Loudspeaker Emitted Speech on ASR performance
...
## 314. Robust fine-tuning of speech recognition models via model merging: application to disordered speech
...
## 315. BR-ASR: Efficient and Scalable Bias Retrieval Framework for Contextual Biasing ASR in Speech LLM
...
## 316. Theoretical proposal for a unified Bayesian model of adaptation in non-interactive and interactive speech production
...
## 317. CMT-LLM: Contextual Multi-Talker ASR Utilizing Large Language Models
...
## 318. Ranking and Selection of Bias Words for Contextual Bias Speech Recognition
...
## 319. Adversarial Deep Metric Learning for Cross-Modal Audio-Text Alignment in Open-Vocabulary Keyword Spotting
...
**Taxonomy:** `recognition-and-alignment / adaptation-and-open-vocabulary / open-vocabulary-recognition`
...
## 320. Fully End-to-end Streaming Open-vocabulary Keyword Spotting with W-CTC Forced Alignment
...
## 321. GLCLAP: A Novel Contrastive Learning Pre-trained Model for Contextual Biasing in ASR
...
## 322. Improving Synthetic Data Training for Contextual Biasing Models with a Keyword-Aware Cost Function
...
## 323. Efficient Trie-based Biasing using K-step Prediction for Rare Word Recognition
...
## 324. WCTC-Biasing: Retraining-free Contextual Biasing ASR with Wildcard CTC-based Keyword Spotting and Inter-layer Biasing
...
## 325. Multilingual Query-by-Example KWS for Indian Languages using Transliteration
...
## 326. Effects of Speaker Count, Duration, and Accent Diversity on Zero-Shot Accent Robustness in Low-Resource ASR
...
## 327. WhisperD: Dementia Speech Recognition and Filler Word Detection with Whisper
...
**Taxonomy:** `recognition-and-alignment / boundaries-and-sequence-structure / disfluency-preservation`
...
## 328. ASR-based segmentation for the analysis of larger child-speech datasets: Performance evaluation on vowels from Australian-English speaking children aged 4 to 11 years
...
**Taxonomy:** `recognition-and-alignment / boundaries-and-sequence-structure / alignment`
...
## 329. Song Form-aware Full-Song Text-to-Lyrics Generation with Multi-Level Granularity Syllable Count Control
...
## 330. Bidirectional Spoken-Written Text Conversion with Large Language Models
...
**Taxonomy:** `recognition-and-alignment / boundaries-and-sequence-structure / long-context-decoding`
...
## 331. A semi-automatic pipeline for transcribing and segmenting child speech
...
## 332. Exploring SSL Discrete Speech Features for Zipformer-based Contextual ASR
...
## 333. SiamCTC:  Learning Speech Representations through Monotonic Temporal Alignment
...
## 334. Towards Multi-Level Transcript Segmentation: LoRA Fine-Tuning for Table-of-Contents Generation
...
## 335. The Multimodal Information Based Speech Processing (MISP) 2025 Challenge: Audio-Visual Diarization and Recognition
...
## 336. StutterCut: Uncertainty-Guided Normalised Cut for Dysfluency Segmentation
...
## 337. Dynamic Context-Aware Streaming Pretrained Language Model For Inverse Text Normalization
...
## 338. Transcript-Prompted Whisper with Dictionary-Enhanced Decoding for Japanese Speech Annotation
...
## 339. Word Level Timestamp Generation for Automatic Speech Recognition and Translation
...
## 340. VoiceNet: Multilingual On-Device Phoneme-To-Audio Alignment
...
## 341. MOVER: Combining Multiple Meeting Recognition Systems
...
## 342. Who knows best? Effects of speech disfluencies on incentivized decision-making
...
## 343. Improving Cross-Attention based on Positional Alignment during Inference for Robust Long-form Speech Recognition
...
## 344. What the Filler? Both ASR Systems and Humans Struggle More With Other Kinds of Disfluencies Than With Filler Particles
...
## 345. On the Language and Gender Biases in PSTN, VoIP and Neural Audio Codecs
...
## 346. AISHELL-5: The First Open-Source In-Car Multi-Channel Multi-Speaker Speech Dataset for Automatic Speech Diarization and Recognition
...
## 347. Voxplorer: Voice data exploration and projection in an interactive dashboard
...
## 348. Improving Low-Resource Dialect Classification Using Retrieval-based Voice Conversion
...
## 349. Influence of Room Acoustics on Objective Voice Assessment Methods in the Context of Speech and Language Therapy
...
## 350. AuralNet: Hierarchical Attention-based 3D Binaural Localization of Overlapping Speakers
...
## 351. Sub-band based Adaptive IIR Algorithm with Biquad Filter Stability Constraints for Feedforward Hear-Through Equalization
...
## 352. Fine-tune Before Structured Pruning: Towards Compact and Accurate Self-Supervised Models for Speaker Diarization
...
## 353. L3C-DeepMFC: Low-Latency Low-Complexity Deep Marginal Feedback Cancellation with Closed-Loop Fine Tuning for Hearing Aids
...
## 354. SepVAC: Multitask Learning of Speaker Separation, Speaker Localization, Microphone Array Localization, and Room Acoustic Parameter Estimation in Various Acoustic Conditions
...
## 355. Conformer-based Ultrasound-to-Speech Conversion
...
## 356. Direction-Aware Neural Acoustic Fields for Few-Shot Interpolation of Ambisonic Impulse Responses
...
## 357. Selective Auditory Attention Decoding in Naturalistic Conversations Using EEG-Based Speech Envelope Tracking in Multi-Speaker Environments
...
## 358. French Listening Tests for the Assessment of Intelligibility, Quality, and Identity of Body-Conducted Speech Enhancement
...
## 359. Recreating Neural Activity During Speech Production with Language and Speech Model Embeddings
...
## 360. Articulatory Feature Prediction from Surface EMG during Speech Production
...
## 361. Unified Microphone Conversion: Many-to-Many Device Mapping via Feature-wise Linear Modulation
...
## 362. Effect of Noise Floor in Room Impulse Response on Speech Perception Under Spherical Harmonics-based Spatial Sound Reproduction
...
## 363. Analysis of Avian Biphonic Vocalization Using Computational Modelling
...
**Taxonomy:** `sound-and-production / source-filter-production / vocal-tract-filter`
...
## 364. Vocal-tract model with two directions: Static design for a dummy head and dynamic design for a speaking machine
...
## 365. Reconstruction of the Complete Vocal Tract Contour Through Acoustic to Articulatory Inversion Using Real-Time MRI Data
...
**Taxonomy:** `sound-and-production / source-filter-production / articulatory-coordination`
...
## 366. Enhancing Acoustic-to-Articulatory Inversion with Multi-Target Pretraining for Low-Resource Settings
...
## 367. Articulatory modeling of the S-shaped F2 trajectories observed in Öhman's spectrographic analysis of VCV syllables
...
## 368. Evaluation of a model for sound radiation from the vocal tract wall
...
## 369. Influence of wall coverings of 3D-printed vocal tract models on measured transfer functions
...
## 370. Speech Reduction in French: The Relationship Between Vowel Space and Articulation Dynamics
...
## 371. Equivalence and differences: Formant patterns of labialization and pharyngealization in Tashlhiyt
...
## 372. Phonetic Posteriorgram-Based Phoneme Selection for Vocal Cord Disorder Classification in Continuous Mandarin Speech
...
## 373. Study of vocal fold vibration using M-mode ultrasound: a proof of concept
...
**Taxonomy:** `sound-and-production / source-filter-production / periodic-source`
...
## 374. Hybrid Expert Knowledge and Self-Supervised Learning for Diagnostic Modeling of Adductor Spasmodic and Primary Myotonic Dysphonia
...
## 375. PERCEPT-US: A Multimodal American English Child Speech Corpus Specialized for Articulatory Feedback
...
## 376. Creaky Voice Facilitates More Efficient Phonological Processing of Mandarin Tone 3
...
## 377. Acoustic similarities, articulatory uniqueness: Speech production mechanisms in individuals with congenital lip paralysis
...
## 378. Articulatory variations in Apical Vowels in Southwestern Mandarin
...
## 379. French schwa is not acoustically distinct  from its two lexical neighbors /ø/ and /œ/
...
## 380. Speaker-specific Patterns of Phonetic Covariation in Korean Word-medial Stops and the Role of Phonological and Morphological Contexts
...
## 381. Supralaryngeal Kinematics of Implosives in Central Vietnamese: An EMA Study
...
## 382. Temporal organization of prenuclear glides in Hefei Mandarin
...
## 401. Finding the Human Voice in AI: Insights on the Perception of AI-Voice Clones from Naturalness and Similarity Ratings
...
**Taxonomy:** `voice-generation-and-control / prosody-and-interactive-control / style-and-emotion-control`
...
## 402. Fine-Tuning Text-to-Speech Diffusion Models Using Reinforcement Learning with Human Feedback
...
## 403. DiEmo-TTS: Disentangled Emotion Representations via Self-Supervised Distillation for Cross-Speaker Emotion Transfer in Text-to-Speech
...
## 404. VibE-SVC: Vibrato Extraction with High-frequency F0 Contour for Singing Voice Conversion
...
**Taxonomy:** `voice-generation-and-control / prosody-and-interactive-control / prosody-control`
...
## 405. From Static to Dynamic: Enhancing AAC with Generative Imagery and Zero-Shot TTS
...
**Taxonomy:** `voice-generation-and-control / prosody-and-interactive-control / interactive-latency`
...
## 406. Voice Impression Control in Zero-Shot TTS
...
## 407. Differentiable Reward Optimization for LLM based TTS system
...
## 408. DnR-nonverbal: Cinematic Audio Source Separation DatasetContaining Non-Verbal Sounds
...
## 409. SOVA-Bench: Benchmarking the Speech Conversation Ability for LLM-based Voice Assistant
...
## 410. LombardTokenizer: Disentanglement and Control of Vocal Effort in a Neural Speech Codec
...
## 411. Prediction of listening effort ratings for habitual and clear-Lombard speech presented in noise
...
## 412. In This Environment, As That Speaker: A Text-Driven Framework for Multi-Attribute Speech Conversion
...
## 413. Spotlight-TTS: Spotlighting the Style via Voiced-Aware Style Extraction and Style Direction Adjustment for Expressive Text-to-Speech
...
## 414. Counterfactual Activation Editing for Post-hoc Prosody and Mispronunciation Correction in TTS Models
...
## 415. Zero-Shot Mono-to-Binaural Speech Synthesis
...
## 416. EME-TTS: Unlocking the Emphasis and Emotion Link in Speech Synthesis
...
## 417. SA-RAS: Speaker-Aware Style Retrieval Augmented Generation for Expressive Zero-Shot Text-to-Speech Synthesis
...
## 418. Accelerating Autoregressive Speech Synthesis Inference With Speech Speculative Decoding
...
## 419. Towards Emotionally Consistent Text-Based Speech Editing: Introducing EmoCorrector and The ECD-TSE Dataset
...
## 420. Investigating Stochastic Methods for Prosody Modeling in Speech Synthesis
...
## 421. Non-Standard Accent TTS Support via Large Multi-Accent Frontend Pronunciation Knowledge Transfer
...
**Taxonomy:** `voice-generation-and-control / text-to-speech-and-content / text-to-speech-planning`
...
## 422. DS-Codec: Dual-Stage Training with Mirror-to-NonMirror Architecture Switching for Speech Codec
...
**Taxonomy:** `voice-generation-and-control / text-to-speech-and-content / neural-vocoder`
...
## 423. AF-Vocoder: Artifact-Free Neural Vocoder with Global Artifact Filter
...
## 424. Accelerating Diffusion-based Text-to-Speech Model Trainingwith Dual Modality Alignment
...
## 425. Scheduled Interleaved Speech-Text Training for Speech-to-Speech Translation with LLMs
...
## 426. Code Mix TTS: An Approach to Infer Human Like Speech for Multi-Lingual Input Texts
...
## 427. Analyzing Mitigation Strategies for Catastrophic Forgetting in End-to-End Training of Spoken Language Models
...
## 428. Vocoder-Projected Feature Discriminator
...
## 429. BitTTS: Highly Compact Text-to-Speech Using 1.58-bit Quantization and Weight Indexing
...
## 430. Revival with Voice: Multi-modal Controllable Text-to-Speech Synthesis
...
## 431. Efficient Streaming TTS Acoustic Model with Depthwise RVQ Decoding Strategies in a Mamba Framework
...
## 432. Long-Context Speech Synthesis with Context-Aware Memory
...
## 433. SpeechSEC: A Unified Multi-Task Framework for Speech Synthesis, Editing, and Continuation
...
## 434. Improving Noise Robustness of LLM-based Zero-shot TTS via Discrete Acoustic Token Denoising
...
## 435. RapFlow-TTS: Rapid and High-Fidelity Text-to-Speech with Improved Consistency Flow Matching
...
## 436. Intelligibility of Text-to-Speech Systems for Mathematical Expressions
...
**Taxonomy:** `voice-generation-and-control / text-to-speech-and-content / intelligibility-naturalness`
...
## 437. Tungnaá In Live Performance: An Implementation Of Interactive Artistic Text-To-Voice
...
## 438. Bridging the Training–Inference Gap in TTS: Training Strategies for Robust Generative Postprocessing for Low-Resource Speakers
...
## 439. Voice Conversion Improves Cross-Domain Robustness  for Spoken Arabic Dialect Identification
...
**Taxonomy:** `voice-generation-and-control / voice-identity-and-conversion / speaker-identity`
...
## 440. VoxAging: Continuously Tracking Speaker Aging with a Large-Scale Longitudinal Dataset in English and Mandarin
...
## 441. Towards Better Disentanglement in Non-Autoregressive Zero-Shot Expressive Voice Conversion
...
**Taxonomy:** `voice-generation-and-control / voice-identity-and-conversion / voice-conversion`
...
## 442. REWIND: Speech Time Reversal for Enhancing Speaker Representations in Diffusion-based Voice Conversion
...
## 443. DAFMSVC: One-Shot Singing Voice Conversion with Dual Attention Mechanism and Flow Matching
...
## 444. Unleashing   the  Inner Monster: Demonstrating High-Fidelity Human to Non-Human  Voice Conversion
...
## 445. ZSDEVC: Zero-Shot Diffusion-based Emotional Voice Conversion with Disentangled Mechanism
...
**Taxonomy:** `voice-generation-and-control / voice-identity-and-conversion / zero-shot-voice`
...
## 446. Unsupervised Rhythm and Voice Conversion to Improve ASR on Dysarthric Speech
...
## 447. Private kNN-VC: Interpretable Anonymization of Converted Speech
...
## 448. Neurodyne: Neural Pitch Manipulation with Representation Learning and Cycle-Consistency GAN
...
## 449. LSCodec: Low-Bitrate and Speaker-Decoupled Discrete Speech Codec
...
## 450. Voices of `cyborg awesomeness': Posthuman embodiment of nonbinary gender expression in AI speech technologies
...
## 451. Mitigating Non-Target Speaker Bias in Guided Speaker Embedding
...
## 452. Facilitating Personalized TTS for Dysarthric Speakers Using Knowledge Anchoring and Curriculum Learning
...
## 453. LinearVC: Linear Transformations of Self-Supervised Features Through the Lens of Voice Conversion
...
## 454. Vo-Ve: An Explainable Voice-Vector for Speaker Identity Evaluation
...
## 455. Training-Free Voice Conversion with Factorized Optimal Transport
...
## 456. Eigenvoice Synthesis based on Model Editing for Speaker Generation
