"""Capture nine new official-PDF INTERSPEECH papers for D3 reading."""
import hashlib, json, subprocess, sys, urllib.request
from pathlib import Path

HERE = Path(__file__).resolve().parent; DATA = HERE / "data"
IDS = ["grinberg25_interspeech", "dong25_interspeech", "alcalapadilla25_interspeech", "elkheir25b_interspeech", "akti25_interspeech", "goebiowska25_interspeech", "du25b_interspeech", "amoniyan25_interspeech", "fang25c_interspeech"]
...
(DATA / "interspeech-2025-fiftyninth-d3-papers.json").write_text(json.dumps({"venue": "INTERSPEECH 2025", "batch_id": "interspeech-2025-d3-batch-059", "papers": rows, "failures": []}, indent=2, ensure_ascii=False) + "\n")
