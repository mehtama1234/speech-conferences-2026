"""Capture an eight-paper D3 reading set for usability, variation, compact modeling, and adaptation."""
import hashlib,json,subprocess,sys,urllib.request
from pathlib import Path
H=Path(__file__).resolve().parent;D=H/"data"
SELECTED={"human-centered-evaluation":"mcallister25_interspeech","accent-and-cultural-boundaries":"do25b_interspeech","time-frequency-measurement":"dong25e_interspeech","text-to-speech-and-content":"hsiao25_interspeech","speaker-characteristics":"cumani25_interspeech","voice-identity-and-conversion":"guo25_interspeech","adaptation-and-open-vocabulary":"kwok25b_interspeech","source-separation-and-spatial-listening":"escobargrisales25_interspeech"}
...
(D/"interspeech-2025-thirtyfifth-d3-papers.json").write_text(json.dumps({"venue":"INTERSPEECH 2025","batch_id":"interspeech-2025-d3-batch-035","papers":rows,"failures":[]},indent=2,ensure_ascii=False)+"\n");print(json.dumps({"papers":len(rows)}))
