...
IDS = ["yong25_interspeech", "wepner25_interspeech", "zhang25e_interspeech", "shi25h_interspeech", "zhang25l_interspeech", "nakagome25_interspeech", "oh25c_interspeech", "ryu25b_interspeech"]
...
(DATA / "interspeech-2025-fiftyeighth-d3-papers.json").write_text(json.dumps({"venue": "INTERSPEECH 2025", "batch_id": "interspeech-2025-d3-batch-058", "papers": rows, "failures": []}, indent=2, ensure_ascii=False) + "\n")
