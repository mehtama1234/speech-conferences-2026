...
DATA = HERE / "data"
IDS = [
    "schouwenaars25_interspeech", "merzougui25_interspeech",
    "duraisamy25_interspeech", "fan25_interspeech",
    "khanday25_interspeech", "gupta25_interspeech",
    "han25_interspeech", "mori25b_interspeech",
]
...
(DATA / "interspeech-2025-fiftieth-d3-papers.json").write_text(json.dumps({"venue": "INTERSPEECH 2025", "batch_id": "interspeech-2025-d3-batch-050", "papers": rows, "failures": []}, indent=2, ensure_ascii=False) + "\n")
