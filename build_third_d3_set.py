#!/usr/bin/env python3
"""Capture a third balanced INTERSPEECH D3 batch from official PDFs."""
...
SELECTED = {
    "signal_and_acoustics": "a25_interspeech",
    "recognition_and_transcription": "alabi25_interspeech",
    "understanding_and_translation": "arora25_interspeech",
    "generation_and_voice": "bakkouche25_interspeech",
    "separation_and_enhancement": "avidan25_interspeech",
    "speaker_and_paralinguistics": "asali25_interspeech",
    "languages_and_people": "ambikairajah25_interspeech",
    "evaluation_and_deployment": "balasubramanian25_interspeech",
}
OUT = HERE / "data/interspeech-2025-third-d3-papers.json"
...
def main() -> None:
    ...
    OUT.write_text(json.dumps({"venue": "INTERSPEECH 2025", "batch_id": "interspeech-2025-d3-batch-003", "papers": rows}, indent=2, ensure_ascii=False) + "\n")
    print(f"wrote {OUT}")
